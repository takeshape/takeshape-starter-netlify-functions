...
The following is a guide to launching a TakeShape project that injects Ecommerce data from a TakeShape project's API into your React project using Netlify Functions.
